...
export function CardSkeleton() {
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center truncate rounded-xl bg-gray-700 px-4 py-8">
...
export function TableRowSkeleton() {
  return (
    <tr className="w-full border-b border-gray-900 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      {/* Customer Name and Image */}
      <td className="relative overflow-hidden whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex items-center gap-3">
          <div className="h-8 w-8 rounded-full bg-gray-900"></div>
          <div className="h-6 w-24 rounded bg-gray-900"></div>
        </div>
      </td>
      {/* Email */}
      <td className="whitespace-nowrap px-3 py-3">
        <div className="h-6 w-32 rounded bg-gray-900"></div>
      </td>
      {/* Amount */}
      <td className="whitespace-nowrap px-3 py-3">
        <div className="h-6 w-16 rounded bg-gray-900"></div>
      </td>
      {/* Date */}
      <td className="whitespace-nowrap px-3 py-3">
        <div className="h-6 w-16 rounded bg-gray-900"></div>
      ...
      <td className="whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex justify-end gap-3">
          <div className="h-[38px] w-[38px] rounded bg-gray-900"></div>
          <div className="h-[38px] w-[38px] rounded bg-gray-900"></div>
        </div>
      </td>
    </tr>
  ...
  return (
    <div className="mb-2 w-full rounded-md bg-gray-700 p-4">
      <div className="flex items-center justify-between border-b border-gray-900 pb-8">
        <div className="flex items-center">
          <div className="mr-2 h-8 w-8 rounded-full bg-gray-900"></div>
          <div className="h-6 w-16 rounded bg-gray-900"></div>
        </div>
        <div className="h-6 w-16 rounded bg-gray-900"></div>
      </div>
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-16 rounded bg-gray-900"></div>
          <div className="mt-2 h-6 w-24 rounded bg-gray-900"></div>
        </div>
        <div className="flex justify-end gap-2">
          <div className="h-10 w-10 rounded bg-gray-900"></div>
          <div className="h-10 w-10 rounded bg-gray-900"></div>
        </div>
      </div>
    </div>
